...
SELECT n.n_nationkey n_key, n.n_name, SUM(t.t_count) num_orders, SUM(t.t_totalprice) cum_price # select nation key, nation name, count of orders, total cumulative price of orders
